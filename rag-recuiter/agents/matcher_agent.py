...
class MatcherAgent(BaseAgent):
    ...
    async def run(self, messages: list) -> Dict[str, Any]:
        ...
        analysis_results_from_DB = self._query_ollama(analysis_prompt)
        parsed_results = self._parse_json_safely(analysis_results_from_DB)
        ...
        skills = analysis_results.get("technical_skills", [])
        experience_level = analysis_results.get("experience_level", "Mid-level")
